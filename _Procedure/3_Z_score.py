...
# Load the dataset
file_path = 'E:\Final year project\Fall Classificaiton\Fall_Classification\Thigh\Balanced_Thigh_combined_data.csv'
...
zscore_normalized_file_path = 'E:\Final year project\Fall Classificaiton\Fall_Classification\Thigh\z_score_norm.csv'
