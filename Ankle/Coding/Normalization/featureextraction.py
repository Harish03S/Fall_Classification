...
# Load dataset
file_path = 'E:/Final year project/Fall Classificaiton/Fall_Classification/Ankle/Normalized_Ankle_Data.csv'
...
# Save to CSV
output_file = 'E:/Final year project/Fall Classificaiton/Fall_Classification/Ankle/Extracted_Features_Grouped.csv'
