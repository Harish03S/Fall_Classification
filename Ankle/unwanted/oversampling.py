...
# Load the dataset
file_path = 'B:/Fall_Classification/Ankle/Ankle_combined_data.csv'
...
scaler = MinMaxScaler()
oversampled_data[sensor_columns] = scaler.fit_transform(oversampled_data[sensor_columns])

# Save the balanced and normalized dataset
oversampled_file_path = 'B:/Fall_Classification/Ankle/Balanced_Data_With_Metadata_Final.csv'
