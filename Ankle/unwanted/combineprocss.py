...
base_dir = 'B:\Fall_Classification\Ankle'  # Replace with the path to the "Ankle" directory

# Define activity folders
activities = ['Activities of daily living', 'Forward Fall labelled', 'Backward Fall labelled', 'Lateral Fall labelled']
...
if all_data:
    ...
    output_file = os.path.join(base_dir, 'Ankle_combined_data.csv')
